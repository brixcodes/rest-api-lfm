    ...
    def _get_email_template(content: str, title: str, language: str = "fr") -> tuple[str, str]:
        ...
        html_body = f"""<!DOCTYPE html>
            ...
            <head>
                ...
                <title>{title}</title>
                <link href="https://fonts.googleapis.com/css?family=PT+Serif:400,700|Poppins:400,700" rel="stylesheet" />
                <style type="text/css">
                    body {{ padding: 0; margin: 0; display: block; min-width: 100%; width: 100%; background: #ffffff; -webkit-text-size-adjust: none; }}
                    .mobile-shell {{ width: 650px; min-width: 650px; }}
                    ...
                    @media only screen and (max-width: 650px) {{ .mobile-shell {{ width: 100%; }} }}
                </style>
            </head>
            <body>
                                ...
                                <tr>
                                    <td style="padding: 30px 0px 40px 0px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="h3 center pb15">{greeting}</td>
                                            </tr>
                                            <tr>
                                                <td class="text center pb15">{content.replace('\n', '<br>')}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-footer2 pb20">{signature}<br>For any questions, contact {contact_link}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
